    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-gray-800 mb-1">Phone</div>
                  <div className="text-gray-600">+27 11 123 4567</div>
                  <div className="text-gray-600">+27 21 987 6543</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">
                    info@freshharvestfoods.co.za
                  </div>
                  <div className="text-gray-600">
                    sales@freshharvestfoods.co.za
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-gray-800 mb-1">Address</div>
                  <div className="text-gray-600">
          ...
          {/* Contact Form */}
          <div>
            <h3 className="text-2xl text-gray-800 mb-6">Send us a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-green-700 text-white px-8 py-4 rounded-lg hover:bg-green-800 transition-colors"
              >
                Send Message
              </button>
            </form>
